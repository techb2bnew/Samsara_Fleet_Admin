...
export function Logo({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" aria-hidden="true">
      ...
      />
      <path d="M5 20.5h21" stroke={COLORS.onAccent} strokeWidth="1.8" strokeLinecap="round" />
      <circle cx="11" cy="22" r="2.2" fill={COLORS.onAccent} />
      <circle cx="22" cy="22" r="2.2" fill={COLORS.onAccent} />
    </svg>
  )
}
